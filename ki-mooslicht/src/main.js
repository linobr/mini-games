...
let preferences={};try{preferences=JSON.parse(storage?.getItem('minigames.ki-mooslicht.settings')||'{}')||{};}catch{}
...
function saveSettings(){try{storage?.setItem('minigames.ki-mooslicht.settings',JSON.stringify(settings));}catch{}}
